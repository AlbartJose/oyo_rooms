          ...
          return (
            <div className="product-details-parent-div">
              <div className="product-details-child-left-div">
                ...
                <p className="located">Located in {e.city}</p>
                <h5>Description</h5>
                <p>{e.description}</p>
                ...
                <div>
                  ...
                  <div className="selected-section">
                    <h4>₹ {e.price} <span className="line-through" >₹ {e.price+20758}</span></h4>
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      This hotel is serviced under the trade name of Hotel
                      Aalishan as per quality standards of OYO
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <h3>What's nearby</h3>
                  <div className="flex">
                    <img src="/general-Icons/redDot.png" className="redDot" alt="no" />
                    <p>{e.name}</p>
                  </div>

                  {/* <img src="" alt="" /> */}
                  <div className="flex location">
                    <img src="/general-Icons/location.svg"  className="redDot" alt="no" />
                  ...
                  <div className="flex map">
                    ...
                    <div>
                      <img src="/general-Icons/map.png" className="map-img" alt="no" />
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex weather">
                    <div>
                      <p>26 Sep</p>
                      <img src="/general-Icons/cloud.png" className="cloud" alt="" />
              ...
              <div className="product-details-child-right-div">
                ...
                <div className="flex coupon-div">
                  <div className="flex">
                    <img src="/general-Icons/coupon-icon.png" className="coupon-icon" alt="" />
